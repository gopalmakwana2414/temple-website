...
const IMAGES = [
  "/images/chhapan bhog matakheda/chppan_bhog1.jpg",
  "/images/chhapan bhog matakheda/chppan_bhog2.jpg",
  "/images/chhapan bhog matakheda/chppan_bhog3.jpg",
  "/images/chhapan bhog matakheda/chppan_bhog4.jpg",
];
...
function GalleryCard({ src, index, onClick }) {
  ...
  return (
    ...
    >
      <img src={src} alt={`Kartik Purnima ${index + 1}`}
        style={{
...
function Lightbox({ images, index, onClose }) {
  ...
  useEffect(() => {
    const h = e => {
      if (images.length > 0) { if (e.key === "ArrowRight") setCurrent(c => (c + 1) % images.length); }
  ...
  return (
    <div onClick={onClose} style={{
      ...
      padding: 20, animation: "kp-lb-in 0.22s ease",
    }}>
      <style>{`@keyframes kp-lb-in{from{opacity:0}to{opacity:1}}`}</style>
...
export default function KartikPurnima() {
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes kp-head-in { from{opacity:0;transform:translateY(-18px)} to{opacity:1;transform:translateY(0)} }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          marginBottom: 8,
          opacity: headVis ? 1 : 0,
          animation: headVis ? "kp-head-in 0.7s ease both" : "none",
        }}>ॐ</div>
        ...
        <h1 style={{
          ...
          opacity: headVis ? 1 : 0,
          animation: headVis ? "kp-head-in 0.8s ease both" : "none",
        }}>
          {lang === "en" ? "Kartik Purnima" : "कार्तिक पूर्णिमा"}
        </h1>
        ...
        <p style={{
          ...
          opacity: headVis ? 1 : 0,
          animation: headVis ? "kp-head-in 0.8s ease 150ms both" : "none",
        }}>
        ...
        <div style={{
          ...
          gap: 10, marginTop: 18,
          opacity: headVis ? 1 : 0,
          animation: headVis ? "kp-head-in 0.8s ease 250ms both" : "none",
        }}>
          ...
          <div style={{
            ...
            {lang === "en" ? (
              <p style={{ fontSize: "clamp(15px,2vw,17.5px)", lineHeight: 1.95, color: "#3a1a00", fontFamily: "'Noto Sans Devanagari','EB Garamond',serif", margin: 0 }}>
                Kartik Purnima, which falls in the holy month of Kartik, is also one of the major festivals celebrated at the temple.
                <br/><br/>
                On this sacred day, special worship of the deity is performed and Chhappan Bhog (56 sacred food offerings) are presented to the Lord.
                <br/><br/>
                Thousands of devotees visit the temple on Kartik Purnima to receive the divine darshan.
                <br/><br/>
                At 4 PM in the evening, a grand Maha Aarti is performed.
                On this occasion, Shri Shri 1008 Mahant Shri Lavkushdas Ji Maharaj, who arrives from Gulabpura, Rajasthan, remains specially present.
                <br/><br/>
                This Maha Aarti is performed by Mahant Shri himself instead of the temple priest.
                <br/><br/>
                After the aarti, Mahaprasad is distributed to the devotees.
                <br/><br/>
                You are warmly invited to visit the temple on Kartik Purnima, receive the divine blessings of the Lord and the darshan of Mahant Shri, and make your life blessed.
                <br/><br/>
                Jai Ho Shri Matakheda Sarkar 🙏
              </p>
            ) : (
              <p style={{ fontSize: "clamp(15px,2vw,17.5px)", lineHeight: 1.95, color: "#3a1a00", fontFamily: "'Noto Sans Devanagari','EB Garamond',serif", margin: 0 }}>
                कार्तिक मास में आने वाली कार्तिक पूर्णिमा भी मन्दिर के प्रमुख त्योहारों में से एक है।
                कार्तिक पूर्णिमा पर भगवान की विशेष पूजा होती हैं एवं छप्पन भोग अर्पित किये जाते हैं।
                हजारों श्रद्धालु कार्तिक पूर्णिमा पर भगवान के दर्शन को यहां पहुंचते हैं।
                <br/><br/>
                शाम 4 बजे महाआरती होती है जिसमे विशेष रूप से राजस्थान के गुलाबपुरा से पधारे
                श्री श्री 1008 महंत श्री लवकुशदास जी महाराज की मुख्य उपस्थिति होती है।
                ये महाआरती पुजारी जी द्वारा नहीं अपितु महंत श्री द्वारा की जाती हैं।
                तत्पश्चात महाप्रसादी का वितरण होता है।
                <br/><br/>
                आप भी एक बार कार्तिक पूर्णिमा पर पधार कर भगवान एवं महंत श्री के दर्शन करें एवं अपने जीवन को धन्य बनाए।
                <br/><br/>
                जय हो श्री माताखेड़ा सरकार की 🙏
              </p>
            )}
